 ...
 * @author USER
 */
public class AddANewBus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 203, 220, 10));
        ...
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 173, 220, 30));

        totalSeatsTextField.setFont(new java.awt.Font("Quicksand Light", 0, 18)); // NOI18N
        totalSeatsTextField.setForeground(new java.awt.Color(153, 95, 238));
        totalSeatsTextField.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        totalSeatsTextField.setBorder(null);
        jPanel2.add(totalSeatsTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 271, 220, 30));

        jSeparator5.setForeground(new java.awt.Color(118, 41, 193));
        jPanel2.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 301, 220, 10));

        FarePerStopTextField.setFont(new java.awt.Font("Quicksand Light", 0, 18)); // NOI18N
        FarePerStopTextField.setForeground(new java.awt.Color(153, 95, 238));
        FarePerStopTextField.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        FarePerStopTextField.setBorder(null);
        jPanel2.add(FarePerStopTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 369, 220, 30));

        jSeparator6.setForeground(new java.awt.Color(118, 41, 193));
        jPanel2.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 399, 220, 10));

        conditionComboBox.setBackground(new java.awt.Color(153, 95, 238));
        conditionComboBox.setFont(new java.awt.Font("Quicksand Book", 0, 14)); // NOI18N
        conditionComboBox.setForeground(new java.awt.Color(153, 95, 238));
        conditionComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Male", "Female" }));
        conditionComboBox.setToolTipText("aeataet");
        conditionComboBox.setBorder(null);
        conditionComboBox.setOpaque(false);
        conditionComboBox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                conditionComboBoxActionPerformed(evt);
            }
        });
        jPanel2.add(conditionComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 474, 230, 30));

        typeComboBox.setBackground(new java.awt.Color(153, 95, 238));
        typeComboBox.setFont(new java.awt.Font("Quicksand Book", 0, 14)); // NOI18N
        typeComboBox.setForeground(new java.awt.Color(153, 95, 238));
        typeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Local", "Seating" }));
        typeComboBox.setToolTipText("aeataet");
        ...
        jPanel2.add(typeComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 180, 250, 30));

        jSeparator8.setForeground(new java.awt.Color(118, 41, 193));
        jPanel2.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 300, 210, 10));

        targetBusStopsTextField.setFont(new java.awt.Font("Quicksand Light", 0, 18)); // NOI18N
        targetBusStopsTextField.setForeground(new java.awt.Color(153, 95, 238));
        targetBusStopsTextField.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        targetBusStopsTextField.setBorder(null);
        jPanel2.add(targetBusStopsTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 270, 210, 30));

        save.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/AddButton.png"))); // NOI18N
        ...
        jPanel2.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 510, 160, 70));

        addBus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/AddLocationButton.png"))); // NOI18N
        ...
        jPanel2.add(addBus, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 270, 60, 40));

        jLabel8.setFont(new java.awt.Font("Quicksand Light", 0, 22)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(144, 98, 213));
        jLabel8.setText("Type");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 130, 210, 30));

        jLabel9.setFont(new java.awt.Font("Quicksand Light", 0, 22)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(144, 98, 213));
        jLabel9.setText("Condition");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 420, 210, 30));

        jLabel10.setFont(new java.awt.Font("Quicksand Light", 0, 22)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(144, 98, 213));
        jLabel10.setText("Target Stops");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 230, 210, 30));

        jLabel11.setFont(new java.awt.Font("Quicksand Light", 0, 22)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(144, 98, 213));
        jLabel11.setText("Total Seats");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, 210, 30));

        jLabel12.setFont(new java.awt.Font("Quicksand Light", 1, 29)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(144, 98, 213));
        jLabel12.setText("Add a bus");
        jPanel2.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, 210, 30));

        jLabel13.setFont(new java.awt.Font("Quicksand Light", 0, 22)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(144, 98, 213));
        jLabel13.setText("Average Fare (BDT)");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 320, 210, 30));

        jLabel14.setFont(new java.awt.Font("Quicksand Light", 0, 22)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(144, 98, 213));
        jLabel14.setText("Bus Name");
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 130, 210, 30));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if (checkFields()) {
            String busName = jTextField5.getText();
    ...
    private void saveMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveMouseEntered
        ImageIcon i = new ImageIcon(getClass().getResource("/Images/AddButtonHover.png"));
        save.setIcon(i);
    }//GEN-LAST:event_saveMouseEntered

    private void saveMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saveMouseExited
        ImageIcon i = new ImageIcon(getClass().getResource("/Images/AddButton.png"));
        save.setIcon(i);
    ...
    private void addBusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBusActionPerformed
        if (checkFields()) {
            if (!targetBusStopsTextField.getText().isEmpty()) {
                ...
                new util.exceptions.ExceptionMoreBusStopRequired().setVisible(true);
    ...
    private boolean checkFields() {
        if (jTextField5.getText().isEmpty() || totalSeatsTextField.getText().isEmpty() || FarePerStopTextField.getText().isEmpty()) {
