 ...
 * the License at Unless required by applicable law or agreed to in writing,
...
/**
 * Implements an auto-complete popup that may be attached to any Swing
 * {@link JTextComponent}.
 *
 * <p>
 * Pressing CTRL-SPACE will show the auto-complete popup. While the popup is
 * shown, all key events related to the following keys are consumed and used to
 * control the proposal selection:</p>
 *
 * <ul>
...
public class AutoCompleteBehaviour<T> {
    ...
    public interface IAutoCompleteCallback<X> {
        ...
        /**
         * Returns the string that should be inserted into the test component.
         *
         ...
         * @param caretPosition caret position where the auto-complete proposal
         * has been triggered
         * @return user input to use for fetching the initial set of proposals
         * or <code>NULL</code> if no proposals are available
         */
     ...
     *
     * <p>
     * Make sure you set a custom {@link IAutoCompleteCallback callback} ,
     * otherwise it will look like auto-completion is not working.</p>
     * <p>
     * This behaviour may only be attached to at most text component at any
     * time. Use {@link #detach()} to detach it from its current editor
     * component.</p>
     *
     ...
     *
     * <p>
     * If this behaviour is currently not attached, nothing (bad) happens.</p>
     *
     * @see #isAttached()
     ...
     *
     * @return <code>true</code> if this behaviour is attached to a text
     * component
     * @see #attachTo(JTextComponent)
     * @see #detach()
     */
