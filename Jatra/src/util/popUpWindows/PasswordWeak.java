 ...
 * @author USER
 */
public class PasswordWeak extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Password is weak. Minimum of 8 characters required.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswordWeak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
