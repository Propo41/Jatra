 ...
 * @author USER
 */
public class ShowBusDetai extends javax.swing.JFrame implements ComponentListener {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowBusDetai.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowBusDetai().setVisible(true);
            }
        });
    }
